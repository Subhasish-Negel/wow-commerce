...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-transparent dark:dark:bg-gray-800 dark:border-white/[0.2] bg-white shadow-input flex justify-center items-center space-x-4 px-8 py-6"
    >
      {children}
    </nav>
  );
